...
if (isset($_SESSION['sb-agent-login']) && isset($_SESSION['sb-agent-login'][1]['id'])) {
    $agent_id = $_SESSION['sb-agent-login'][1]['id'];
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div id="sb-admin" class="settings-cnt sb-php">
        ...
        <div class="cnt-header">
            ...
            <a class="sb-version" href="#">v 1.3</a>
        </div>
                    ...
                    <div class="panel-inner">
                        ...
                        <div class="item-row">
                            <div class="item-title">
                                ...
                                <p>
                                    Click the button to start the Slack synchronization. Localhost not receive messages, only live domains.
                                    Insert the access token and the channel ID into the
                                    <i>slack-token</i> and
                                    <i>slack-channel</i> settings of file
                                    <i>config.php</i>.
                                </p>
                            </div>
                            <div class="item-setting">
                    ...
                    <div class="panel-inner">
                        ...
                        <div class="item-row">
                            <div class="item-title">
                                ...
                                <p>
                                    Click the button to start the Dialogflow synchronization. Insert the Refresh Token into config.php file. Check the docs for more details.
                            ...
                            <div class="item-setting">
                                <a href="https://accounts.google.com/o/oauth2/auth?scope=email https://www.googleapis.com/auth/dialogflow&response_type=code&access_type=offline&redirect_uri=https://board.support/dialogflow/&client_id=611747210174-8omn8dseg2mjcms62rd414rg2d3s2ktr.apps.googleusercontent.com&prompt=consent" target="_blank" class="button action">
                                    Start Dialogflow synchronization
                                </a>
                            </div>
                        </div>
                        <div class="clear"></div>
